    ...
    <Content>
      <HeaderContainer>
        ...
        </Mark>
        {
          showBar && (
            <LinkContainer>
              <RiCloseCircleLine className = 'close_icon' onClick={()=>setShowBar(false)} />
              <LinkGroup>
        ...
        <Search />
        {!showBar && (
            <TiThMenuOutline className='menu_icon' onClick={()=>setShowBar(true)} />
          )
        }
        {showBar &&(
            <HeaderButton>  
              <Button width={230} height={40} fsize={20} content='Content Wallet' />
            </HeaderButton>
          )
        }
      </HeaderContainer>
